*Source: https://vbpl.vn/TW/Pages/vbpq-toanvan.aspx?ItemID=48298*
...
|  |
| --- |
| **CHÍNH PHỦ**    Số: 05/2015/NĐ-CP |

|  |
| --- |
| **CỘNG HOÀ XÃ HỘI CHỦ NGHĨA VIỆT NAM**  **Độc lập - Tự do - Hạnh phúc**  *Hà Nội, ngày 12 tháng 1 năm 2015* |

**NGHỊ ĐỊNH**

**Quy định chi tiết và hướng dẫn thi hành** **một số nội dung** **của** **B****ộ luật** **L****ao độn****g**
...
* Bản PDF:
  + [05.2015.NĐ.CP.pdf](javascript:downloadfile('VanBanGoc_05.2015.NĐ.CP.pdf','/FileData/TW/Lists/vbpq/Attachments/48298/VanBanGoc_05.2015.NĐ.CP.pdf');)
* File đính kèm:
  + [05.2015.NĐ.CP.doc](javascript:downloadfile('05.2015.NĐ.CP.doc','/TW/Lists/vbpq/Attachments/48298/05.2015.NĐ.CP.doc');)
    - **([Xem nhanh](/tw/_layouts/15/WopiFrame.aspx?sourcedoc=/TW/Lists/vbpq/Attachments/48298/05.2015.NĐ.CP.doc))**
